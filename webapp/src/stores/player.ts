...
export const OPENSKULL_USER_ID = getOrStoreNewVariable(
  OPENSKULL_USER_ID_KEY,
  randomUUID()
);

const OPENSKULL_USER_SECRET_KEY = 'Openskull_usersecret';
export const OPENSKULL_USER_SECRET = getOrStoreNewVariable(
...
export const playerConnection = readable<HubConnection | undefined>(
  undefined,
  function start(set) {
...
export const playerConnectionState = readable<string>(
  newPlayerConnection.state,
  function start(set) {
